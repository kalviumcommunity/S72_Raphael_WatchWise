...
function Signup({ setIsAuthenticated }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            //https://s72-raphael-watchwise.onrender.com/api/auth/register
            //http://localhost:3000/api/auth/register
            const response = await axios.post(`${Endpoint}/api/auth/register`, {
                name,
                email,
                password
            });
        ...
        <div className="min-h-screen bg-black relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                {backgroundMovies.map((movie, index) => (
                    ...
                    >
                        <div className="absolute inset-0 bg-gradient-to-r from-black via-black/40 to-black/60" />
            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-4 pt-20 pb-12">
                <div className="w-full max-w-md">
                    {/* Card */}
                    <div className="bg-black/75 backdrop-blur-md rounded-xl px-8 sm:px-16 py-12 sm:py-16 shadow-2xl border border-gray-800">
                        {/* Title */}
